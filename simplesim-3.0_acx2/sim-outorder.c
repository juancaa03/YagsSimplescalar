...
static int yags_config[4] =
  { /* l1size */1, /* l2size */1024, /* hist */8, /* xor */0};
...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_string(odb, "-bpred",
		 "branch predictor type {nottaken|taken|perfect|bimod|2lev|comb|yags}",   // yags added-----------------------------
  ...
  opt_reg_int_list(odb, "-bpred:yags",
		   ...
		   /* default */yags_config,
                   /* print */TRUE, /* format */NULL, /* !accrue */FALSE);    // yags added---------------------------
